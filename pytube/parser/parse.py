...
from pytube.parser import streams
...
async def get_player_config(video_url, with_formats=True):
    ...
    async with aiohttp.ClientSession() as client:
        ...
        return await player_config_parser(get_content, video_url, with_formats)


async def player_config_parser(get_content, video_url, with_formats=True):
